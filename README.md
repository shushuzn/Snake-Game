...
- v1.4.0：AI对战与多人系统 - AI对战模式（简单/普通/困难/地狱四个难度级别，智能寻路算法，反应速度和决策能力根据难度调整）；AI对战排行榜（各难度最佳战绩记录）；智能AI行为（路径寻找、食物追踪、障碍物避让、策略性决策）；多人实时对战（本地2-4人，各自独立控制，碰撞淘汰机制，死亡变障碍物，排名系统）。

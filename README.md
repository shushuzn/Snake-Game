...
- **系统机制**：障碍、硬核模式、连击、任务、成就、图鉴、高对比显示开关、精简HUD开关、失焦自动暂停开关、创意工坊规则分享。
- **局外成长**：肉鸽词条 + 肉鸽点成长。
...
```bash
python3 skills/snake-feature-evolver/scripts/bump_version.py 0.33.0
```

## 最新进展

- v0.33.0：新增创意工坊，可生成/复制/应用规则代码分享配置。
